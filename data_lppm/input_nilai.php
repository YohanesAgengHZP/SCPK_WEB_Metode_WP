<?php
	...
	if ($jml_pn!="" && $jml_pl!="" && $jml_sm!="" && $jml_pg!=""){
		if($jml_jia!="" || $jml_ji!="" || $jml_jna!="" || $jml_jn!="" || $jml_jl!=""){
			$cek = mysqli_query($koneksi,"select * from data_lppm where id_dosen='$id_dos'");
			...
			$nilai = mysqli_query($koneksi,"update dosen_peserta set c5='$c5', c6='$c6', c7='$c7', c8='$c8', c9='$c9' where id_dosen='$id_dos'");
