    ...
    <div class="navbar navbar-inverse navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="homepage.php">SPK Dosen Terbaik</a>
        </div>
    ...
    <?php
      if (isset($_GET['aksi'])){
        ...
        if($aksi=="daftar"){
          ...
          if($st['status']=="0"){
            echo "<script>alert('Pendaftaran belum dibuka');document.location='homepage.php' </script> ";            
          }else{
          ...
          if ($r > 0){
            ...
            $ins = mysqli_query($koneksi,"insert into dosen_peserta (id_dosen, nip, nama) values ('', '$nim', '$us[nama]')");
